 ...
 */
UCLASS(ClassGroup=(Custom), meta=(BlueprintSpawnableComponent, DisplayName = "XB Soldier Debug"))
...
public:
     ...
     * @param bEnable 是否启用
     */
    UFUNCTION(BlueprintCallable, Category = "XB|Debug", meta = (DisplayName = "启用调试显示"))
    void SetDebugEnabled(bool bEnable);

    /**
     * @brief 获取是否启用调试
     */
    UFUNCTION(BlueprintPure, Category = "XB|Debug", meta = (DisplayName = "是否启用调试"))
    bool IsDebugEnabled() const { return bEnableDebug; }

    /**
     * @brief 启用所有显示选项
     */
    UFUNCTION(BlueprintCallable, Category = "XB|Debug", meta = (DisplayName = "启用所有选项"))
    void EnableAllOptions();

    /**
     * @brief 禁用所有显示选项
     */
    UFUNCTION(BlueprintCallable, Category = "XB|Debug", meta = (DisplayName = "禁用所有选项"))
     ...
     * @param bEnable 是否启用
     */
    UFUNCTION(BlueprintCallable, Category = "XB|Debug", meta = (DisplayName = "全局启用调试"))
    static void SetGlobalDebugEnabled(bool bEnable);

    /**
     * @brief 获取全局调试状态
     */
    UFUNCTION(BlueprintPure, Category = "XB|Debug", meta = (DisplayName = "获取全局调试状态"))
...
protected:
    ...
    /** @brief 文字缩放 */
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "XB|Debug|显示配置", 
        meta = (DisplayName = "文字缩放", ClampMin = "0.5", ClampMax = "3.0"))
