...
struct XIAOBINDATIANXIA_API FXBMeleeHitConfig
{
    ...
    /** @brief 检测半径 */
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "检测配置", meta = (DisplayName = "检测半径", ClampMin = "1.0"))
...
public:
    ...
    virtual FString GetNotifyName_Implementation() const override { return TEXT("XB近战命中"); }
